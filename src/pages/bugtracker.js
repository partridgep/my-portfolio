...
export default function BugTracker(props) {
    ...
    const bugTracker = {
        ...
        blurb: <p><span>Why Bugs? </span>Writing code in an organized fashion is a necessity, and doubly so when working in teams. I wanted to build a tool that would be useful to people I would collaborate with on a day-to-day basis.</p>,
