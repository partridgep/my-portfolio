        ...
        <div className={styles.About} id="about">
              <div style={{height: 'max-content'}} className={styles.textWrapper}>
                <div className={styles.text} >
                    ...
                    <p>If you would've seen me then, I would have been furiously typing on my keyboard, looking up how to add more and more complexities to my projects. Since then, I have been fortunate to join the team at Peapod Digital Labs, and keep learning by doing, regularly contributing enhancements to a widely-used platform.</p>
